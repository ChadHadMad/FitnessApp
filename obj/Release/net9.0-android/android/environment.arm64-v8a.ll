...
@dso_apk_entries = dso_local local_unnamed_addr global [99 x %struct.DSOApkEntry] zeroinitializer, align 8
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [25 x i8] c"libaot-FitnessApp.dll.so\00", align 1
...
@.DSOCacheEntry.80_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 1
...
@.DSOCacheEntry.86_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 1
@.DSOCacheEntry.87_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 1
...
@.DSOCacheEntry.91_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
...
@.DSOCacheEntry.94_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 1
